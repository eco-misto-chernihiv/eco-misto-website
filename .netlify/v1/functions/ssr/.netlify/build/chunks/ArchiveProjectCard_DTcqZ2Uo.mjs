import { c as createAstro, a as createComponent, r as renderComponent, b as renderTemplate, f as renderTransition, m as maybeRenderHead } from './astro/server_D3nJfXsh.mjs';
import { b as $$Frame, c as $$MyPicture, g as getCollection, a as $$Row } from './Frame_BNwDIMOF.mjs';
import { a as getSortedProjects, b as getTimePeriod } from './helpers_DmOFTI2X.mjs';
import { g as getRelativeLocaleUrl, h as $$Link, c as $$Stack, i as $$Cluster, d as $$Heading, e as $$Text, $ as $$Icon } from './BaseLayout_B6BAOn-F.mjs';
import { g as getProjectIdWithoutLang, $ as $$ProjectCard, a as $$TimePeriod } from './TimePeriod_D2GntHXY.mjs';
/* empty css                         */
/* empty css                         */
import { $ as $$Image } from './internal_D_PfUj8P.mjs';
import { b as buttonsData } from './favicon_B09fRVez.mjs';
...
const $$ActiveProjectCard = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "ProjectCard", $$ProjectCard, { "class:list": ["active-project", classList], ...rest, "data-astro-cid-enunb7jp": true }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Link", $$Link, { "href": siteUrl, ...projectId === "maysternya-mista" ? { isExternal: true, target: "_blank" } : "", "data-astro-cid-enunb7jp": true }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Stack", $$Stack, { "space": "space-8", "data-astro-cid-enunb7jp": true }, { "default": ($$result4) => renderTemplate` ${renderComponent($$result4, "Frame", $$Frame, { "ratio": "4:3", "class": "cover-wrapper", "data-astro-cid-enunb7jp": true }, { "default": ($$result5) => renderTemplate` ${renderComponent($$result5, "MyPicture", $$MyPicture, { "src": cover.image, "width": 600, "alt": "", "data-astro-cid-enunb7jp": true, "data-astro-transition-scope": renderTransition($$result5, "ebp7e4ow", "", `${projectId}-image`) })} ` })} ${renderComponent($$result4, "Cluster", $$Cluster, { "noWrap": true, "justify": "between", "alignItems": "baseline", "space": "space-7", "data-astro-cid-enunb7jp": true }, { "default": ($$result5) => renderTemplate` ${renderComponent($$result5, "Stack", $$Stack, { "space": "space-3", "data-astro-cid-enunb7jp": true }, { "default": ($$result6) => renderTemplate` ${renderComponent($$result6, "Heading", $$Heading, { "tagName": "h4", "size": "h5", "class": "title font-heading color-secondary", "data-astro-cid-enunb7jp": true, "data-astro-transition-scope": renderTransition($$result6, "zjdkco3t", "", `${projectId}-title`) }, { "default": ($$result7) => renderTemplate`${title}` })} ${renderComponent($$result6, "Text", $$Text, { "tagName": "p", "size": "medium", "class": "color-black description", "data-astro-cid-enunb7jp": true, "data-astro-transition-scope": renderTransition($$result6, "by2rzvnd", "", `${projectId}-description`) }, { "default": ($$result7) => renderTemplate`${description}` })} ` })} ${renderComponent($$result5, "Icon", $$Icon, { "name": "icon-arrow-right", "aria-hidden": "true", "focusable": "false", "class": "color-primary", "data-astro-cid-enunb7jp": true })} ` })} ` })} ` })} ` })} `;
}, "/Users/vladkovac-mbp/Documents/Web Development/eco-misto-website/src/components/ActiveProjectCard.astro", "self");
