import { e as createAstro, c as createComponent, m as maybeRenderHead, k as addAttribute, s as spreadAttributes, b as renderSlot, a as renderTemplate, j as defineStyleVars, r as renderComponent, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, u as unescapeHTML, n as escape, o as renderUniqueStylesheet, p as renderScriptElement, q as createHeadAndContent } from './astro/server_-TgDsRa7.mjs';
import { e as getBreakpoints } from './helpers_DmOFTI2X.mjs';
/* empty css                                                           */
/* empty css                         */
import { e as $$Picture, r as removeBase, c as isRemotePath, V as VALID_INPUT_FORMATS, f as prependForwardSlash } from './internal_CSE0eue_.mjs';
import { d as $$Text } from './BaseLayout_p89_ALhG.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DLdXWihn.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_BS9H5HNj.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./internal_CSE0eue_.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DNE62X4h.mjs');
...
export { $$ProjectCard as $, $$Frame as a, $$MyPicture as b, getCollection as c, $$Row as d, $$TimePeriod as e, $$Section as f, getProjectIdWithoutLang as g, renderEntry as r };
