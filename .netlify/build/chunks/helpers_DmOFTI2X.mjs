 ...
 */
function getLogo(locale, isMobile) {
  const suffix = isMobile ? "-compact" : "";
  return `ecomisto-logo-${locale}${suffix}`;
}

export { getSortedProjects as a, getTimePeriod as b, createResponse as c, decodeBase64 as d, getBreakpoints as e, getRatio as f, generateLiqPaySignature as g, getLogo as h, parseTitle as p };
