import { c as createAstro, a as createComponent, l as defineStyleVars, m as maybeRenderHead, g as addAttribute, s as spreadAttributes, d as renderSlot, b as renderTemplate, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, u as unescapeHTML, o as escape, p as renderUniqueStylesheet, q as renderScriptElement, t as createHeadAndContent, r as renderComponent } from './astro/server_D3nJfXsh.mjs';
/* empty css                         */
import { r as removeBase, c as isRemotePath, V as VALID_INPUT_FORMATS, e as prependForwardSlash, f as $$Picture } from './internal_D_PfUj8P.mjs';
import { e as getBreakpoints } from './helpers_DmOFTI2X.mjs';
/* empty css                                                           */
/* empty css                         */
...
}, "/Users/vladkovac-mbp/Documents/Web Development/eco-misto-website/src/components/ui/Section.astro", void 0);
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BlWx_sGW.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://ecomisto.org", "SSR": true};
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_Pusz2fmS.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./internal_D_PfUj8P.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_BKUXQQpO.mjs');
...
}, "/Users/vladkovac-mbp/Documents/Web Development/eco-misto-website/src/components/compositions/Row.astro", void 0);
...
const $$MyPicture = createComponent(($$result, $$props, $$slots) => {
  ...
  const { src, alt, width, class: classList, ...rest } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "Picture", $$Picture, { "class:list": [classList], "src": src, "alt": alt, "width": width, "formats": ["avif", "webp"], "densities": [1.5, 2], ...rest })}`;
}, "/Users/vladkovac-mbp/Documents/Web Development/eco-misto-website/src/components/ui/MyPicture.astro", void 0);
...
}, "/Users/vladkovac-mbp/Documents/Web Development/eco-misto-website/src/components/compositions/Frame.astro", void 0);

export { $$Section as $, $$Row as a, $$Frame as b, $$MyPicture as c, getCollection as g, renderEntry as r };
