import { c as createAstro, a as createComponent, m as maybeRenderHead, g as addAttribute, r as renderComponent, b as renderTemplate, d as renderSlot, F as Fragment } from './astro/server_D3nJfXsh.mjs';
import { j as $$Shape, d as $$Heading, e as $$Text, a as $$Center, c as $$Stack, f as $$Button, $ as $$Icon, g as getRelativeLocaleUrl } from './BaseLayout_B6BAOn-F.mjs';
import { $ as $$Section, c as $$MyPicture, a as $$Row, b as $$Frame, g as getCollection } from './Frame_BNwDIMOF.mjs';
/* empty css                         */
import { d as achievmentsData, m as missionData, b as buttonsData, p as partnersData } from './favicon_B09fRVez.mjs';
/* empty css                         */
import { p as parseTitle, a as getSortedProjects } from './helpers_DmOFTI2X.mjs';
import { b as $$AutoGrid, c as $$Marquee, d as $$EmptyShape } from './EmptyShape_8Ag9PXdL.mjs';
import { g as gizLogo } from './giz_4WortYbu.mjs';
import { $ as $$ArchiveProjectCard, a as $$ActiveProjects } from './ArchiveProjectCard_DTcqZ2Uo.mjs';
import { $ as $$ButtonArrow } from './ButtonArrow_C3puYtHv.mjs';
...
const $$Youtube = createComponent(async ($$result, $$props, $$slots) => {
  ...
  try {
    ...
    youtubeVideos = data.items.filter((item) => !item.snippet.title.includes("#")).map((item) => {
      return {
...
const repairTogether = new Proxy({"src":"/_astro/logo-repair-together.B2yqYQTU.png","width":1200,"height":256,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/vladkovac-mbp/Documents/Web Development/eco-misto-website/src/assets/images/logo-repair-together.png";
							}
...
const $$ArchiveProjects = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const title = currentLocale === "ua" ? "\u0420\u0435\u0430\u043B\u0456\u0437\u043E\u0432\u0430\u043D\u0456 \u043F\u0440\u043E\u0435\u043A\u0442\u0438" : "Completed projects";
