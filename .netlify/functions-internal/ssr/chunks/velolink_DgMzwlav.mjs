...
const url = "src/content/projects/velolink.mdx";
const file = "/Volumes/Media HD/Web Development/ecomisto/src/content/projects/velolink.mdx";
...
Content.moduleId = "/Volumes/Media HD/Web Development/ecomisto/src/content/projects/velolink.mdx";
__astro_tag_component__(Content, 'astro:jsx');

export { Content, __usesAstroImage, Content as default, file, frontmatter, getHeadings, url, velolinkImages };
