...
import { d as $$Icon } from './BaseLayout_oBDNaKon.mjs';
...
function _createMdxContent(props) {
  const _components = {
    ...
    p: "p",
    ...props.components
  }, {Badge, Blockquote, BlockquoteFooter, Centered, Gallery, Logos, ResultIcon, ResultItem, Results, TextContent} = _components;
  ...
  if (!ResultIcon) _missingMdxReference("ResultIcon");
  if (!ResultItem) _missingMdxReference("ResultItem");
  if (!Results) _missingMdxReference("Results");
    ...
    children: ["\n", "\n", createVNode(Centered, {
      ...
      children: createVNode(TextContent, {
        children: [createVNode(Badge, {
          ...
          children: [createVNode(ResultItem, {
            children: [createVNode(ResultIcon, {
              name: "icon-heart"
            }), createVNode(_components.p, {
              children: "Розроблено новий проєкт Організації дорожнього руху"
            })]
          }), createVNode(ResultItem, {
            children: [createVNode(ResultIcon, {
              name: "icon-heart"
            }), createVNode(_components.p, {
