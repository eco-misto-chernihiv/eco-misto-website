import { a as createComponent, b as renderTemplate, m as maybeRenderHead, e as renderSlot, d as renderComponent, f as createAstro, g as addAttribute, s as spreadAttributes, h as defineStyleVars, F as Fragment, u as unescapeHTML } from './astro/server_CFD6V1YY.mjs';
import { a as $$Frame, b as $$TimePeriod, c as $$ProjectCard, d as $$Row, e as $$MyPicture, g as getCollection, $ as $$Section } from './TimePeriod_L07Q6a_p.mjs';
import { b as getTimePeriod, e as getRatio, a as getSortedProjects, f as getProjectIndex } from './helpers_C1eUHQX2.mjs';
import { $ as $$Heading, d as $$Link, a as $$Stack, e as $$Cluster, f as $$Text, g as $$Icon, h as $$Shape, i as $$Button, j as $$SideModal, k as $$Donate, b as $$Center, c as $$BaseLayout } from './BaseLayout_BUBBflPD.mjs';
/* empty css                          */
import { $ as $$Image, a as $$Picture } from './_astro_assets_CBy1yhCu.mjs';
import { $ as $$Partnership, a as $$EmptyShape, b as $$AutoGrid } from './AutoGrid_DhYQm5KP.mjs';
...
const $$SingleSlideGallery = createComponent(($$result, $$props, $$slots) => {
  ...
  })} </div> <div class="swiper-navigation" data-astro-cid-3i3kvsn4> ${renderComponent($$result, "SwiperButtons", $$SwiperButtons, { "data-astro-cid-3i3kvsn4": true })} </div> </div> ${renderComponent($$result, "Annotation", $$Annotation, { "data-astro-cid-3i3kvsn4": true }, { "default": ($$result2) => renderTemplate` ${renderSlot($$result2, $$slots["default"])} ` })} </div> `;
...
const $$ResultList = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Stack", $$Stack, { "space": "space-2", "tagName": "ul", "class": "list", "role": "list", "data-astro-cid-lnhiwkmg": true }, { "default": ($$result2) => renderTemplate`${listItems.map((item) => {
