const id = "velokuhnya.mdx";
						...
						const body = "\n# Heading\n\nSome text\n";
						const data = {title:"Велокухня",description:"Соціальна веломайстерня для покращення сталої мобільності у постраждалих від бойових дій та деокупованих громадах.",cover:
					...
					,isCollage:true,pubDate:new Date(1715731200000),isActive:true};
						const _internal = {
							type: 'content',
