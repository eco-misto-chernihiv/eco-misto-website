import { a as createComponent, b as renderTemplate, m as maybeRenderHead, e as renderSlot, d as renderComponent, f as addAttribute, s as spreadAttributes, g as createAstro, h as defineStyleVars } from './astro/server_BrDdyJt0.mjs';
import { b as $$Frame, a as $$AutoGrid, g as getCollection, $ as $$Section, c as $$MyPicture } from './AutoGrid_G1euslbO.mjs';
import { $ as $$Heading, d as $$Icon, e as $$Cluster, b as $$Center, f as $$Shape, g as $$Text, a as $$Stack, c as $$BaseLayout } from './BaseLayout_CsNwc_Ze.mjs';
/* empty css                          */
...
const $$H3 = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Heading", $$Heading, { "tagName": "h3", "size": "h5" }, { "default": ($$result2) => renderTemplate`${renderSlot($$result2, $$slots["default"])}` })}`;
...
const $$Centered = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="project-row"> ${renderComponent($$result, "Center", $$Center, { "maxWidth": "75rem", "space": { default: "space-6", tablet: "space-7", laptop: "space-9" } }, { "default": ($$result2) => renderTemplate` ${renderSlot($$result2, $$slots["default"])} ` })} </div>`;
