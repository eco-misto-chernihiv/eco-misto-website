...
import { h as $$Shape, b as $$Heading, c as $$Text, $ as $$Center, j as achievmentsData, a as $$Stack, f as $$Cluster, g as $$Icon, i as $$Button, e as $$BaseLayout } from './BaseLayout_DMLmU-ob.mjs';
import { f as $$MyPicture, $ as $$Section, e as $$Row, b as $$Frame, g as getCollection, a as $$ButtonArrow } from './TimePeriod_B26qK_Gl.mjs';
/* empty css                         */
import { a as $$SwiperPaginationProgress, $ as $$SwiperButton, d as $$AutoGrid, c as $$Marquee, b as $$EmptyShape } from './AutoGrid__Ah_rJsE.mjs';
import { p as parseTitle, a as getSortedProjects } from './helpers_78RTG-S2.mjs';
import { $ as $$ArchiveProjectCard, a as $$ActiveProjects } from './ArchiveProjectCard_BELGUnGN.mjs';
...
Громадська організація «Еко Місто Чернігів» — це урбаністична
            ...
            активації публічних просторів і формування спільнот.
` })} ${renderComponent($$result5, "Button", $$Button, { "style": "primary", "isInverted": true, "data-open-partnership": true, "aria-label": "Open cooperation form modal", "data-astro-cid-ewxirvlt": true }, { "default": ($$result6) => renderTemplate`Написати
