import { a as createComponent, b as renderTemplate, m as maybeRenderHead, f as addAttribute, d as renderComponent, g as createAstro, h as defineStyleVars, s as spreadAttributes, e as renderSlot } from './astro/server_BrDdyJt0.mjs';
import { f as $$Shape, $ as $$Heading, g as $$Text, b as $$Center, h as achievmentsData, a as $$Stack, d as $$Icon, i as $$Button, j as cooperationData, c as $$BaseLayout } from './BaseLayout_CsNwc_Ze.mjs';
import { c as $$Row, $ as $$ArchiveProjectCard, b as $$ActiveProjects, a as $$ButtonArrow } from './ArchiveProjectCard_CGr7fK7X.mjs';
import { c as $$MyPicture, $ as $$Section, b as $$Frame, g as getCollection, a as $$AutoGrid } from './AutoGrid_G1euslbO.mjs';
/* empty css                         */
import { $ as $$EmptyShape } from './EmptyShape_DiAAnIdK.mjs';
...
const $$Donors = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="donors" data-astro-cid-ocsizvzk> ${renderComponent($$result, "Center", $$Center, { "maxWidth": "125rem", "space": "space-4", "data-astro-cid-ocsizvzk": true }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Stack", $$Stack, { "space": "space-9", "data-astro-cid-ocsizvzk": true }, { "default": ($$result3) => renderTemplate` <div class="title" data-astro-cid-ocsizvzk> ${renderComponent($$result3, "Text", $$Text, { "tagName": "div", "size": "medium", "class": "color-dark-gray", "isBadge": true, "variant": "outline", "data-astro-cid-ocsizvzk": true }, { "default": ($$result4) => renderTemplate`Донори` })} </div> ${renderComponent($$result3, "Marquee", $$Marquee, { "direction": "left", "space": "space-4", "duration": "slow", "data-astro-cid-ocsizvzk": true }, { "default": ($$result4) => renderTemplate` <div class="donor-logos marquee-inner" data-astro-cid-ocsizvzk> ${donors.map((donor) => {
    return renderTemplate`<div class="donor-logo" data-astro-cid-ocsizvzk> ${renderComponent($$result4, "Icon", $$Icon, { "name": donor.name, "data-astro-cid-ocsizvzk": true })} </div>`;
  })} </div> ` })} ` })} ` })} </section> `;
...
` })} ${renderComponent($$result7, "PartnershipModal", $$PartnershipModal, { "data-astro-cid-pqooy3ar": true }, { "default": ($$result8) => renderTemplate` ${renderComponent($$result8, "Partnership", $$Partnership, { "data-astro-cid-pqooy3ar": true })} ` })} ` })} ` })} ` })} ${renderComponent($$result4, "Stack", $$Stack, { "space": "space-8", "data-astro-cid-pqooy3ar": true }, { "default": ($$result5) => renderTemplate` ${renderComponent($$result5, "Marquee", $$Marquee, { "direction": "left", "space": "space-11", "duration": "slow", "data-astro-cid-pqooy3ar": true }, { "default": ($$result6) => renderTemplate` <div class="partner-logos marquee-inner" data-astro-cid-pqooy3ar> <div class="partner-logo" data-astro-cid-pqooy3ar> ${renderComponent($$result6, "Icon", $$Icon, { "name": "partners-sendpulse", "data-astro-cid-pqooy3ar": true })} </div> <div class="partner-logo" data-astro-cid-pqooy3ar> ${renderComponent($$result6, "Icon", $$Icon, { "name": "partners-ahalar", "data-astro-cid-pqooy3ar": true })} </div> <div class="partner-logo" data-astro-cid-pqooy3ar> ${renderComponent($$result6, "Icon", $$Icon, { "name": "partners-tolocar", "data-astro-cid-pqooy3ar": true })} </div> <div class="partner-logo" data-astro-cid-pqooy3ar> ${renderComponent($$result6, "Icon", $$Icon, { "name": "partners-u-cycle", "data-astro-cid-pqooy3ar": true })} </div> <div class="partner-logo" data-astro-cid-pqooy3ar> ${renderComponent($$result6, "Icon", $$Icon, { "name": "partners-agenciya", "data-astro-cid-pqooy3ar": true })} </div> <div class="partner-logo" data-astro-cid-pqooy3ar> ${renderComponent($$result6, "Icon", $$Icon, { "name": "partners-chernigiv-it", "data-astro-cid-pqooy3ar": true })} </div> </div> ` })} ${renderComponent($$result5, "Marquee", $$Marquee, { "direction": "right", "space": "space-11", "duration": "slow", "data-astro-cid-pqooy3ar": true }, { "default": ($$result6) => renderTemplate` <div class="partner-logos marquee-inner" data-astro-cid-pqooy3ar> <div class="partner-logo" data-astro-cid-pqooy3ar> ${renderComponent($$result6, "Icon", $$Icon, { "name": "partners-mart", "data-astro-cid-pqooy3ar": true })} </div> <div class="partner-logo" data-astro-cid-pqooy3ar> ${renderComponent($$result6, "Icon", $$Icon, { "name": "partners-ostriv", "data-astro-cid-pqooy3ar": true })} </div> <div class="partner-logo" data-astro-cid-pqooy3ar> ${renderComponent($$result6, "Icon", $$Icon, { "name": "partners-politehnika", "data-astro-cid-pqooy3ar": true })} </div> <div class="partner-logo" data-astro-cid-pqooy3ar> ${renderComponent($$result6, "Icon", $$Icon, { "name": "partners-uma", "data-astro-cid-pqooy3ar": true })} </div> <div class="partner-logo" data-astro-cid-pqooy3ar> ${renderComponent($$result6, "Icon", $$Icon, { "name": "partners-zelenew", "data-astro-cid-pqooy3ar": true })} </div> </div> ` })} ` })} ` })} </div> ` })} ` })} `;
