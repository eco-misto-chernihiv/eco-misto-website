...
<TextContent>
  Майстерня розташована за адресою: [Проспект Левка Лук'яненка,
  2А](https://maps.app.goo.gl/ZS49Y47vxbkQsASo9) і працює по буднях з 11:00 до
  17:00.
</TextContent>

{/* TODO: Add Forza logos */}
